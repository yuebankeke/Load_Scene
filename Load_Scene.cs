...
public class Load_Scene : MonoBehaviour {
    ...
    private const float loadScene_Style_Speed=0.04f;//加载的速度。可根据喜好调节。
    ...
    /// <summary>传入跳转到的场景的名称
    /// </summary>
    public void Initialize_Value(string loadScene_Name1)
    {
    ...
    void Start () {
        ...
        img_Load_Value = transform.FindChild("Img_Load_Bg/Img_Load_Value").GetComponent<Image>();
        t_Load_Valu = img_Load_Value.transform.parent.FindChild("T_Load_Valu").GetComponent<Text>();
    ...
    IEnumerator Load_Scene_Style()
    {
        for (float i=loadScene_Style_Speed;i< 1+ loadScene_Style_Speed; i+= loadScene_Style_Speed)
        {
            ...
            t_Load_Valu.text = "加载中: " + Mathf.RoundToInt(img_Load_Value.fillAmount * 100) + " % ";
